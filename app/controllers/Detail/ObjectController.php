 	...
 	class ObjectController extends BaseDetailController {
		...
		# -------------------------------------------------------
 		...
 		public function GetRepresentationInfo() {
 			...
 			$va_opts = array('display' => 'media_overlay', 'object_id' => $vn_object_id, 'order_item_id' => $pn_order_item_id, 'onlyShowRepresentationsInOrder' => ($pn_order_item_id ? true : false), 'containerID' => 'caMediaPanelContentArea', 'access' => caGetUserAccessValues($this->request));
