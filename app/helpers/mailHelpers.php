 ...
 */
   ...
   */ 
	...
	* Sends mail message using specified view and variable to merge
	 ...
	 */
	function caSendMessageUsingView($po_request, $pa_to, $pa_from, $ps_subject, $ps_view, $pa_values) {
		...
		return caSendmail($pa_to, $pa_from, $ps_subject, null, $o_view->render($ps_view));
	}
	# ------------------------------------------------------------------------------------------------
?>