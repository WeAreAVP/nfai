...
#
define("__CA_BASE_DIR__", "/home/nfai/public_html");
...
#
define("__CA_APP_NAME__", "folklore");
...
#
define("__CA_APP_DISPLAY_NAME__", "NFAI");
...
$_CA_THEMES_BY_DEVICE = array(
	...
	'_default_' 	=> 'nfai'		// use the 'default' theme for everything else
);
