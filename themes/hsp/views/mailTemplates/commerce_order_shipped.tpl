<?php
	...
	$vn_ship_date = $t_order->get('shipped_on_date', array('GET_DIRECT_DATE' => true));
?>
...
<p>Your order <?php print $t_order->getOrderNumber(); ?> submitted on <?php print date('F j, Y g:i a', (int)$t_order->get('created_on', array('GET_DIRECT_DATE' => true))); ?> was shipped via <?php print $vs_shipping_method; ?> on <?php print date('F j, Y', $vn_ship_date); ?>.</p>
