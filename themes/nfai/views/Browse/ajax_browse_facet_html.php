...
<div class="modal-header">
    <button type="button" class="close" onclick="caUIBrowsePanel.hideBrowsePanel()">×</button>
    <div id="title" class="modal-heading"><?php print 'Browse ' . unicode_ucfirst($va_facet_info['label_plural']); ?></div>
</div>

<div  id="browseSelectPanelContentArea">
	<div>
		<div style="margin-left: 10px;">
			<?php //echo '<pre>'; print_r(caGetStateList());exit; ?>
			<div class="btn-group">
				<button class="btn splash-css">State</button>
				<button class="btn dropdown-toggle" style="padding-bottom: 12px;" data-toggle="dropdown">
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu">

					<li><input type="checkbox" style="padding-top: 0;margin-top: -5px;margin-left: 8px;" /><span style="display:inline;padding: 3px 12px;" href="javascript://;">Alaska</span></li> 
					<li><input type="checkbox" style="padding-top: 0;margin-top: -5px;margin-left: 8px;" /><span style="display:inline;padding: 3px 12px;" href="javascript://;">Alabama</span></li> 
					<li><input type="checkbox" style="padding-top: 0;margin-top: -5px;margin-left: 8px;" /><span style="display:inline;padding: 3px 12px;" href="javascript://;">Arkansas</span></li> 
					<li><input type="checkbox" style="padding-top: 0;margin-top: -5px;margin-left: 8px;" /><span style="display:inline;padding: 3px 12px;" href="javascript://;">Arizona</span></li> 
					<li class="divider"></li>
					<li><span href="javascript://;" style="padding: 3px 12px;">Clear</span></li>
				</ul>
			</div>
		</div>
	</div>
		...
		switch ($va_facet_info['group_mode'])
		{
			...
			default:
				...
				if ($vb_individual_group_display)
				{
					...
					{
						$vs_g = array_shift(array_keys($va_grouped_items));
					}
				}
...
<div class="modal-footer">
    <button class="btn" onclick='caUIBrowsePanel.hideBrowsePanel();'>Close</button>
