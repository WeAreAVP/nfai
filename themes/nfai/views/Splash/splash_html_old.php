	...
	<div id="hpBrowseDiv">
		<div id="hpBrowse">
			...
			<div id="hpBrowseFacet">
				...
				{
					?>
					<a href="#" style="white-space:nowrap;" onclick='caUIBrowsePanel.showBrowsePanel("<?php print $vs_facet_name; ?>");
				return false;'><?php print ucwords($va_facet_info['label_plural']); ?></a>
					<?php
				}
				?>
			</div>
